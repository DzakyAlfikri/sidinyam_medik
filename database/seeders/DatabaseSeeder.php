...
class DatabaseSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $admin = User::firstOrCreate([
            ...
            'age' => '20',
            'number' => '085731013100',
            'email' => 'dzakyalfikridesember@gmail.com',
            'address' => 'Purwokerto',
            'email_verified_at' => now(),
            'password' => Hash::make('adminjaki1'),
        ...
        $user = User::firstOrCreate([
            ...
            'age' => '20',
            'number' => '085731013101',
            'email' => 'dzaky.alfikri@mhs.unsoed.ac.id',
            'address' => 'Purbalingga',
            'email_verified_at' => now(),
            'password' => Hash::make('userjaki1'),
            'remember_token' => Str::random(10),
        ]);
        ...
        $pakar = User::firstOrCreate([
            ...
            'age' => '30',
            'number' => '081234567890',
            'email' => 'alfiproduction28@gmail.com',
            'address' => 'Yogyakarta',
            'email_verified_at' => now(),
            'password' => Hash::make('pakarjaki1'),
            'remember_token' => Str::random(10),
        ]);
